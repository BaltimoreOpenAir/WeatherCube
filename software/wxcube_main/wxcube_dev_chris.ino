...
void sendData() {
  ...
  for (int reading_counter = loop_counter; reading_counter > 1; reading_counter--) {
    ...
    Serial.print("write_location: ");Serial.println(eeprom_write_location);
    Serial.print("reading_counter: ");Serial.println(reading_counter);
    //Serial.print("write_location: ");Serial.println(eeprom_write_location);
