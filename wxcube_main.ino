...
//          }
  ...
  void read_data()
  {
    ...
    long toc = millis();
    while (millis() - toc < 60000) {

      //  while(minute- minute_0 < TOTAL_MEASUREMENT_TIME){
    ...
    data_array[11] = x * (sht32.readHumidity() +  sht31.readHumidity()) * 0.5 ; // take humidity means to fit
